...
// The real signatures are type arguments rather than named-but-unused params, which this config's
...
const createResetPwdMailer = vi.fn<(linkBase?: string, linkPath?: string) => typeof boundMailer>(() => boundMailer)
